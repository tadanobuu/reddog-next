...
const RedDogRules = ({ setPage }) => {
  const [isTestOpen, setIsTestOpen] = useState(false)

  return (
    <div className="max-w-3xl mx-auto p-4 bg-gray-100 rounded-lg shadow">
      <Button onClick={() => setPage(true)} className="mb-4">ゲームに戻る</Button>
      
      <h1 className="text-3xl font-bold mb-6 text-center">レッドドッグの遊び方</h1>
        ...
        <ol className="list-decimal list-inside space-y-4">
          ...
          <li>
            ...
            <CardSet cards={[
              ...
              isTestOpen
                ? 'https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEgaKrSnV7GsU65gpkC3OrfzmbUdkCq7wVVCtt7B7lsZqSfrqHaZFUtlnmIZuJkvU5EqBOF8cMJePdJDfGxFc2K7DgavW_glB48bcSsluvmIhAFhTnQT6DGwECwElLvL_bk_icQk0PjX7ljy/s800/card_spade_07.png'
                : 'https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEhUCE0FkJ5HUq_NFpqPB9GCMfqxgsOtEptXJCdlHe8ES8HkwGRfe5U3hQZoR_4RqFn-u2BYwNc9jUOHtgI0uUEAEjQsD3TZFzH-8fJHlEk29YHHkUe0oOSC4E9wUefe0c2BA88eORbO8ylj/s800/card_back.png'
            ]} />
            <div className="flex space-x-2 mt-2">
          ...
          <li>
            ...
            <Button
              ...
              className={`mt-2 ${isTestOpen ? 'bg-blue-500 hover:bg-blue-600' : 'bg-green-500 hover:bg-green-600'}`}
            >
              {isTestOpen ? 'CLOSE' : 'OPEN'}
            </Button>
      ...
      <Button onClick={() => setPage(true)} className="mt-6">ゲームに戻る</Button>
    </div>
  )
}
